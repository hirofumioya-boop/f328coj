...
const NEWS_ITEMS = [
  {
    date: "2026年5月",
    tag: "ツーリング",
    title: "横浜テストツーリング 2026.05",
    body: "毎年恒例の横浜ツーリング。前泊組との集合場所で偶然クラシックカーラリーを見学する機会にも恵まれました。328×6台含む計10台16名で山下公園まで走りました。",
    link: { url: "/touring/report/2026-test-touring.html", text: "レポートを読む →" }
  },
  {
    date: "2026年5月",
    tag: "ツーリング",
